...
pub enum Atom
{
	...
	StringNVAtom(NVStrings),         // TODO: Figure out how I want to model this ...
	ByteNVAtom(u8),            // TODO: Figure out how I want to model this ...
...
impl Atom {
	pub fn atom_type(&self) -> AtomType {
		match self 
		{
			...
			Atom::StringNVAtom(_)    => AtomType::Data,
